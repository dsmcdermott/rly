// DO NOT EDIT THIS FILE. This file is automatically generated by 'build.rs', combining
// the module documentation at 'src/parser_doc.md' with the code from 'src/lib_content.rs'.
//
