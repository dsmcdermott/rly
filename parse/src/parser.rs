...
/// A trait providing a generic interface for [Parsers].
///
/// [`new`](Self::new) creates a new [`Parser`] from a token stream, and
/// [`parse`](Self::parse) processes the token stream into an [`Ast`].
///
/// These methods [can also be found in the public interfaces of the parser types
/// generated by this crate](crate#a-note-about-traits). This means that importing this
/// trait is often not necessary when using [Parsers].
///
/// [Parsers]: crate#using-parsers
